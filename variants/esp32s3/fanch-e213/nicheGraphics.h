...
#include "graphics\niche\InkHUD\Applets\Examples\NewMsgExample\NewMsgExampleApplet.h"
#include "graphics\niche\InkHUD\Applets\User\tempHygroTelem\tempHygroTelem.h"
#include "graphics\niche\InkHUD\Applets\User\tempHygroPort67\tempHygroPort67.h"

//#include "graphics/niche/InkHUD/Applets/Examples/AHT10/EnvApplet.h"
...
void setupNicheGraphics()
{
    ...
    inkhud->addApplet("All Messages", new InkHUD::AllMessageApplet, true, false); // Activated, autoshown
    ...
    //inkhud->addApplet("new Message ex", new InkHUD::NewMsgExampleApplet, true, true); // Activated, autoshown
    inkhud->addApplet("tempHygroPort67", new InkHUD::tempHygroPort67); // Activated, autoshown
    //inkhud->addApplet("tempHygroTelem", new InkHUD::tempHygroTelem); // Activated, autoshown
